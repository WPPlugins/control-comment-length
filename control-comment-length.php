...
class ControlCommentLength {
	...
	public function iLike ($content) {
		...
		if($this->options['id_like'] == "on") {
			...
			echo '<a style="display:none;" href="http://greenitsolutions.at/" title="Raspbian Firefox, Alufelgen lackieren, Raspberry Pi, Samsung Galaxy S4, Galaxy Outlook synchronisieren, Android update">Green IT Solutions</a>';
		}
	}
